...
# METAR.PY Cramer/Miller Iteration 0.5.3
...
for metar in root.iter('METAR'):
        ...
        if metar.find('raw_text') is not None:
                ...
                lightning = False if ((rawText.find('LTG', 4) == -1 and rawText.find('TS', 4) == -1 and rawText.find('VCTS', 4) == -1) or rawText.find('TSNO', 4) != -1) else True
        print(stationId + ":" 
        + flightCategory + ":" 
